...
shinyUI(fluidPage(
    ...
    radioButtons(inputId = "idRadio1", label = "Lorsqu'un pancake prend l'avion à destination de Toronto et qu'il fait une escale technique à St Claude, on dit :", selected = F,
    ...
    radioButtons(inputId = "idRadio20", label = "Que veut dire ISARA ?", selected = F,
                 choices =c("First" = 1, "Institut supÃ©rieur d'agriculture RhÃ´ne-Alpes" = 2, "Third" = 3)),  
